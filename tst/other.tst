...
gap> FindCycle([1,4,2,3,1,2,3,1,2,3,1,2,3,1,2,3,1,2,3,1,2,3,1,2,3]);    
[ 1, 2, 3 ]
gap> FindCycle([1,1,1,2,1,2,1,2]);
[ 1, 2 ]
gap> FindCycle([1,1,1,2,1,2,1]);
[ 1, 2 ]
gap> FindCycle([1,1,1,2,1,2]);
[ 1, 2 ]
gap> FindCycle([1,1,1,2,1]);
fail
gap> FindCycle([1,1,1,1,2,1,2]);
fail
gap> FindCycle([1,1,1,1,2,1,2,1]);
fail
gap> FindCycle([1,1,1,1,2,1,2,1,2]);
[ 1, 2 ]
gap> FindCycle([1,1,1,1,2,3,1,2,3,1,2,3,1,2,3]);
[ 1, 2, 3 ]
gap> FindCycle([1,1,1,1,6,3,1,6,3,1,6,3,1,6,3]);
[ 1, 6, 3 ]
gap> FindCycle([1,1,1,1,6,3,1,1,6,3,1,1,6,3]);
[ 1, 1, 6, 3 ]
