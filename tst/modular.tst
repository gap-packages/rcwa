...
Surjective rcwa mapping of GF(2)[x] with modulus x+x^2+x^3
...
[ Z(2)^0+x^2, Z(2)^0+x+x^2, x+x^3, x+x^2+x^3, x^3, x^2+x^3 ]
gap> H := Action(G,orb);
Group([ (1,2)(3,4,5,6), (1,3)(2,4) ])
gap> c := Comm(r,s);
<bijective rcwa mapping of GF(2)[x] with modulus x^2+x^3+x^4>
gap> Display(c);
 
Bijective rcwa mapping of GF(2)[x] with modulus x^2+x^3+x^4
 
    P mod x^2+x^3+x^4     |                        P^f
--------------------------+---------------------------------------------------
 0*Z(2)                   |
 Z(2)                     |
 x                        |
...
Constant rcwa mapping of GF(9)[x] with value Z(3)^0+x^2
gap> Display(f);
Constant rcwa mapping of GF(9)[x] with value Z(3)^0+x^2
gap> String(f);
