...
polynomial rings over finite fields. In particular it can be used
for computations with bijective such mappings and infinite
permutation groups generated by them.

It is completely written in the GAP language and neither contains
nor requires external binaries.
