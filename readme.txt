...
[C]lass-[W]ise [A]ffine groups  by means of computation.  In principle,  this
package can deal at least with the following types of groups:
...
ses of the integers and which contains all the above groups.
