...
# An example of a mapping $sigma_2$ showing that the orbit unions of residue
# classes (mod Mod($sigma_2$)) are not necessarily disjoint.
# The orbits on $\Z$ under the action of the group generated by $sigma_1$
# and $sigma_2$ seem to be all finite, although the group itself is infinite.
