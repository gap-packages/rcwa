...
#############################################################################
##
#O  ClassTranspositionConjugationBall( <G>, <maxmod> )
##
##  The arguments of this operation are a group <G> generated by class
##  transpositions and a positive integer <maxmod>.
##  The return value is the consisting of the class transpositions
##  with modulus less than or equal to <maxmod> which can be obtained from
##  the generators of <G> by successive conjugation, without encountering
##  elements in between which are not class transpositions.
##  The ball is returned as a list of spheres.
##
DeclareOperation( "ClassTranspositionConjugationBall",
