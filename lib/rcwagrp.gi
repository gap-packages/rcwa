...
##
##  Returns the simple group which is generated by the set of all
...
InstallMethod( CTCons,
  ...
  function ( filter, P, R )
    ...
    SetStructureDescription( G, Name( G ) );
    if P = [] then # Higman-Thompson group / Thompson's group V
      ...
      SetGeneratorsOfGroup(G,List([[0,2,1,2],[1,2,2,4],[0,2,1,4],[1,4,2,4],
                                   ...
                                   [0,4,1,6],[0,6,1,8]],ClassTransposition));
    fi;
    return G;
  end );
