...
##
##  This is a special method for two class transpositions which are both not
##  equal to n -> n + (-1)^n, under the conjugation action of CT(<R>).
...
InstallMethod( RepresentativeActionOp,
               ...
               [ IsNaturalCT, IsRcwaMapping, IsRcwaMapping, IsFunction ], 50,
